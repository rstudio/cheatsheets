...
#| column: margin
source("common.R")
use_cheatsheet_logo("readr", alt = "Hex logo for readr - a white document icon going dowards into a dark blue funnel, with a white icon of a data table coming out the narrow end, all on a blue background.")
