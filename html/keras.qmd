...
![Convolution Neural Network (CNN)](images/keras-convolution-diagram.png){width="600" fig-align="center" fig-alt="A diagram that provides a conceptual overview of how a CNN works"}
...
to be pre-processed
    ...
    feature_space <- layer_feature_space(
      features = l
    ist(float_var = feature_float_normalized(),
...
[![](images/keras-book.png){width="600" fig-align="center" fig-alt="A diagram that provides a conceptual overview of how a CNN works"}](https://www.manning.com/books/deep-learning-with-r-third-edition)
