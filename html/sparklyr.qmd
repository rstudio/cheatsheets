...
-   `ml_metrics_binary()`, `ml_metrics_regression()`, `ml_metrics_multiclass()` - Extract metrics from a table of predictions and actual values into a concise tibble, similar to how yardstick metric functions work.
